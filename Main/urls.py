...
urlpatterns = [
 ...
 path('dashbord/properys/', views.admin_propertes, name='properts'),
 ...
 path('dashbord/add-aria/', views.add_aria, name='add_aria'),
 path('dashbord/add-building/', views.add_building_type, name='add_building'),
 path('dashbord/add-city/', views.add_city, name='add_city'),
