...
DATABASES = {
    'default': dj_database_url.parse('postgresql://mo_j1hf_user:ldADILv8rC8Utg1v8VmNPw8YsMNOV0iL@dpg-d87m3cojo6nc73bbki70-a.frankfurt-postgres.render.com/mo_j1hf')
}
